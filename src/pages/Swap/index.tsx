import { CurrencyAmount, JSBI, Token, Trade } from '@soy-libs/sdk'
import React, { useCallback, useContext, useEffect, useMemo, useState, useRef } from 'react'
import { ArrowDown } from 'react-feather'
import { CardBody, ArrowDownIcon, Button, IconButton, Text, useModal, Link, Flex } from '@soy-libs/uikit'
  ...
  useEffect(() => {
    ...
    if (doesInputMatch && doesOutputMatch) {
      ...
      if (modalCountdownSecondsRemaining <= 0) {
        window.location.href = 'https://exchange.soyswap.finance/#/swap'
      }
            ...
            <BottomGrouping>
              {disableSwap && (
                <Flex alignItems="center" justifyContent="center" mb="1rem">
                  <Text color="failure">
                    Please use{' '}
                    <StyledLink external href="https://exchange.soyswap.finance">
                      SoySwap V2
                    </StyledLink>{' '}
                    to make this trade
                  </Text>
              ...
              {!account ? (
                ...
                <GreyCard style={{ textAlign: 'center' }}>
                  <Text mb="4px" style={{color: theme.colors.failure}}>{TranslateString(1194, 'Insufficient liquidity for this trade.')}</Text>
                </GreyCard>
              ) : showApproveFlow ? (
                <RowBetween>
                  <Button
