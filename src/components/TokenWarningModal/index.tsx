...
import { getCallistoScanLink, shortenAddress } from '../../utils'
    ...
    <Wrapper error={duplicateNameOrSymbol}>
      <AutoRow gap="6px">
        ...
        <AutoColumn gap="10px" justify="flex-start">
          ...
          {chainId && (
            <ExternalLink style={{ fontWeight: 400 }} href={getCallistoScanLink(chainId, token.address, 'token')}>
              <Text title={token.address}>
                {shortenAddress(token.address)} {TranslateString(116, '(View on Callisto Scan)')}
              </Text>
            </ExternalLink>
          )}
        </AutoColumn>
